...
/* ===== PREVENT DROPDOWN ZOOM & MOVEMENT ===== */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    filterSelect.addEventListener('touchstart', function(e) {
        // Add a class to track touch state
        this.classList.add('touching');
    }, { passive: true });
    
    filterSelect.addEventListener('touchend', function() {
        this.classList.remove('touching');
    });
    
    // Prevent focus from moving/zooming
    filterSelect.addEventListener('focus', function(e) {
        console.log('Dropdown focused - preventing zoom');
        
        // Force styles to keep it in place
        ...
        // Add visual feedback without moving
        this.style.boxShadow = '0 0 0 3px rgba(212, 175, 55, 0.5)';
