...
|------|-----|--------------|
| Primary | `#7A1028` | `--color-primary` |
| On Primary | `#FFF8E9` | `--color-on-primary` |
| Secondary | `#2C160F` | `--color-secondary` |
| Accent/CTA | `#9B6A18` | `--color-accent` |
| Background | `#FBF4E7` | `--color-background` |
| Foreground | `#2C160F` | `--color-foreground` |
| Muted | `#EFE2C9` | `--color-muted` |
| Border | `#D3AE63` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#1C1917` | `--color-ring` |

**Color Notes:** Bridal maroon, antique gold, ivory, and dark rosewood create an Indian heritage-luxury identity. Gold is ornamental; maroon carries primary actions and status emphasis.
...
**Style:** Indian Heritage Editorial

**Keywords:** Bridal maroon, antique gold, ivory, rosewood, ceremonial, heirloom, editorial, restrained ornament
